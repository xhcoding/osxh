...
void make_window8(unsigned char *buf, int xsize, int ysize, char *title, char act) {
    ...
    boxfill8((char *)buf, xsize, COL8_C6C6C6, 0, 0, xsize - 1, 0);
    boxfill8((char *)buf, xsize, COL8_FFFFFF, 1, 1, xsize - 2, 1);
    boxfill8((char *)buf, xsize, COL8_C6C6C6, 0, 0, 0, ysize - 1);
    boxfill8((char *)buf, xsize, COL8_FFFFFF, 1, 1, 1, ysize - 2);
    boxfill8((char *)buf, xsize, COL8_848484, xsize - 2, 1, xsize - 2, ysize - 2);
    boxfill8((char *)buf, xsize, COL8_000000, xsize - 1, 0, xsize - 1, ysize - 1);
    boxfill8((char *)buf, xsize, COL8_C6C6C6, 2, 2, xsize - 3, ysize - 3);
    boxfill8((char *)buf, xsize, COL8_848484, 1, ysize - 2, xsize - 2, ysize - 2);
    boxfill8((char *)buf, xsize, COL8_000000, 0, ysize - 1, xsize - 1, ysize - 1);
...
void make_wtitle8(unsigned char *buf, int xsize, char *title, char act)  {
    ...
    boxfill8((char *)buf, xsize, tbc, 3, 3, xsize - 4, 20);
